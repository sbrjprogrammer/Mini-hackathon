  ...
  let navigate = useNavigate()
   ...
   const handleChange=(e)=>{
    ...
    const postData = async(e)=>{
        e.preventDefault()
        const {name,email,work,phone,password,cpassword}=userData
                      ...
                      <form method='POST' className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            ...
                            <label className="form-label" htmlFor="form3Example3c">Your Profession</label>
                            <input type="text" name='work' value={userData.work} onChange={handleChange} id="form3Example3c" className="form-control" />
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            ...
                            <input type="text" name='password' value={userData.password} onChange={handleChange} id="form3Example4c" className="form-control" />
                          </div>
                        </div>
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            ...
                            <input type="text" name='cpassword' value={userData.cpassword} onChange={handleChange} id="form3Example4cd" className="form-control" />
                          </div>
                        </div>
